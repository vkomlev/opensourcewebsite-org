...
use app\modules\groupBot\helpers\PaginationButtons;
use app\modules\groupBot\telegram\Message;
...
class FilterController extends CommandController
{
    ...
    public function actionLanguage($language = null)
    {
        \Yii::$app->responseMessage->setKeyboard(new \TelegramBot\Api\Types\Inline\InlineKeyboardMarkup(
            [
                [
                    ['callback_data' => 'language_list', 'text' => \Yii::t('groupBot', 'Change Language')],
                ],
            ]
        ));
    ...
    public function actionCurrency($currency = null)
    {
        \Yii::$app->responseMessage->setKeyboard(new \TelegramBot\Api\Types\Inline\InlineKeyboardMarkup(
            [
                [
                    ['callback_data' => 'currency_list', 'text' => \Yii::t('groupBot', 'Change Currency')],
                ],
            ]
        ));
